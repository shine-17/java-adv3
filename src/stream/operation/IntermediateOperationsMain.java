...
public class IntermediateOperationsMain {
    public static void main(String[] args) {
        ...
        // 7. limit
        System.out.println("7. limit - 처음 n개 요소만");
        numbers.stream()
                .limit(5)
                .forEach(n -> System.out.print(n + " "));
        System.out.println("\n");
        ...
        // 8. skip
        System.out.println("8. skip - 처음 n개 요소 건너뛰기");
        numbers.stream()
                .skip(5)
                .forEach(n -> System.out.print(n + " "));
        System.out.println("\n");
        ...
        // 9. takeWhile (Java 9+)
        System.out.println("9. takeWhile - n보다 작은 동안만 선택");
        numbers2.stream()
                .takeWhile(n -> n < 5)
                .forEach(n -> System.out.print(n + " "));
        System.out.println("\n");
        ...
        // 10. dropWhile(Java 9+)
        System.out.println("10. dropWhile - n보다 작은 동안 건너뛰기");
        numbers2.stream()
                .dropWhile(n -> n < 5)
                .forEach(n -> System.out.print(n + " "));
        System.out.println("\n");
